...
import { scheduleExam, destroyScheduler, parseExam, shuffleExam, removeCorrectOptions } from '../utils/examFunctions';
...
export const getAllUpcomingExams = catchAsync(async (req: Request, res: Response) => {
  const db = getDb();
  let query =
